...
export const INVITATION = {
  ...
  mapUrl:
    "https://www.google.com/maps/search/?api=1&query=Bayastan+restaurant+Osh+Navruz+53",
  taxiUrl: "https://2gis.kg/osh/search/Bayastan%20restaurant",

  invitationText:
    "үйлөнүү үлпөт тоюна келип, биздин кубанычыбызга ортоктош болуп, той кечесинин кадрлуу коногу болуп кетүүгө чакырабыз. Бул өзгөчө күнү сиздер менен бирге өткөрүү биз үчүн чоң бакыт.",
